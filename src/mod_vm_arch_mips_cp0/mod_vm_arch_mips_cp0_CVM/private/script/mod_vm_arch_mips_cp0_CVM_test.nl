...
def mod_vm_arch_mips_cp0_access_special(var root, var vaddr, var mask, var op_code, var op_type, var op_size, var data, var exc, var ret)
{
    var name_value_hash<> = <"vaddr":vaddr,"mask":mask,"op_code":op_code,"op_type":op_type,"op_size":op_size,"data":data,"exc":exc>
    var json_args
...
def run_access_special(var root, var run_state)
{
    ...
    mod_vm_arch_mips_cp0_access_special(root,vaddr,mask,op_code,op_type,op_size,data,exc,ret_access_special)
}

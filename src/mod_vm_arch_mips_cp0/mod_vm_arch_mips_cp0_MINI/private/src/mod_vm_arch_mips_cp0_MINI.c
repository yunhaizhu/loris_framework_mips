...
/**
 * @file    mod_vm_arch_mips_cp0_MINI.c
...
#include "mod_vm_arch_mips_cp0_MINI.h"
...
/**
 * mod_vm_arch_mips_cp0_MINI_init
 * @brief   
 * @param   p_m
 * @param   arg
 * @param   arg_len
 ...
 */
STD_CALL std_rv_t mod_vm_arch_mips_cp0_MINI_init(IN mod_vm_arch_mips_cp0_t * p_m, IN const std_char_t * arg,
...
/**
 * mod_vm_arch_mips_cp0_MINI_cleanup
 * @brief   
 * @param   p_m
 * @return  STD_CALL std_rv_t
 */
STD_CALL std_rv_t mod_vm_arch_mips_cp0_MINI_cleanup(mod_vm_arch_mips_cp0_t * p_m)
{
	mod_vm_arch_mips_cp0_imp_t *p_imp_m = (mod_vm_arch_mips_cp0_imp_t *) p_m;
	mod_iid_t mod_shell_iid = MOD_SHELL_IID;
	std_char_t key[BUF_SIZE_128] = "\0";
...
/**
 * mod_vm_arch_mips_cp0_MINI_reset
 * @brief   
 * @param   p_m
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cp0_MINI_reset(IN mod_vm_arch_mips_cp0_t * p_m)
{
...
/**
 * mod_vm_arch_mips_cp0_MINI_trigger_exception
 * @brief   
 * @param   p_m
 * @param   type
 * @param   cause
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cp0_MINI_trigger_exception(IN mod_vm_arch_mips_cp0_t * p_m, IN std_uint_t type,
								IN std_uint_t cause)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_tlb_op
 * @brief   
 * @param   p_m
 * @param   op_type
 * @param   insn
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cp0_MINI_tlb_op(IN mod_vm_arch_mips_cp0_t * p_m, IN std_uint_t op_type,
						     IN std_uint_t insn)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_tlb_lookup
 * @brief   
 * @param   p_m
 * @param   vaddr
 * @param   res
 ...
 */
STD_CALL std_int_t mod_vm_arch_mips_cp0_MINI_tlb_lookup(IN mod_vm_arch_mips_cp0_t * p_m, IN std_uint_t vaddr,
							IN std_void_t * res)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_mtc_op
 * @brief   
 * @param   p_m
 * @param   cp0_reg
 * @param   val
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cp0_MINI_mtc_op(IN mod_vm_arch_mips_cp0_t * p_m, IN std_uint_t cp0_reg,
						     IN std_uint_t val)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_mfc_op
 * @brief   
 * @param   p_m
 * @param   cp0_reg
 * @param   sel
 ...
 */
STD_CALL std_uint_t mod_vm_arch_mips_cp0_MINI_mfc_op(IN mod_vm_arch_mips_cp0_t * p_m, IN std_uint_t cp0_reg,
						     IN std_uint_t sel)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_access_special
 * @brief   
 * @param   p_m
 * @param   vaddr
 * @param   mask
 ...
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cp0_MINI_access_special(IN mod_vm_arch_mips_cp0_t * p_m, IN std_uint_t vaddr,
...
/**
 * mod_vm_arch_mips_cp0_MINI_irq_op
 * @brief   
 * @param   p_m
 * @param   type
 * @param   irq
 * @return  STD_CALL             std_int_t
 */
STD_CALL std_int_t mod_vm_arch_mips_cp0_MINI_irq_op(IN mod_vm_arch_mips_cp0_t * p_m, IN std_uint_t type,
						    IN std_uint_t irq)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_timer
 * @brief   
 * @param   p_m
 * @return  STD_CALL             std_int_t
 */
STD_CALL std_int_t mod_vm_arch_mips_cp0_MINI_timer(IN mod_vm_arch_mips_cp0_t * p_m)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_eret
 * @brief   
 * @param   p_m
 * @return  STD_CALL             std_int_t
 */
STD_CALL std_int_t mod_vm_arch_mips_cp0_MINI_eret(IN mod_vm_arch_mips_cp0_t * p_m)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
/**
 * mod_vm_arch_mips_cp0_MINI_soft_fpu
 * @brief   
 * @param   p_m
 * @return  STD_CALL             std_int_t
 */
STD_CALL std_int_t mod_vm_arch_mips_cp0_MINI_soft_fpu(IN mod_vm_arch_mips_cp0_t * p_m)
{
    mod_vm_arch_mips_cp0_imp_t *p_vm_arch_mips_cp0_imp = (mod_vm_arch_mips_cp0_imp_t *)p_m;
    cvm_arch_mips_cp0_t *cp0 = &p_vm_arch_mips_cp0_imp->cp0;
...
struct mod_vm_arch_mips_cp0_ops_st mod_vm_arch_mips_cp0_MINI_ops = {
	mod_vm_arch_mips_cp0_MINI_init,
	mod_vm_arch_mips_cp0_MINI_cleanup,
 ...
 * @return  STD_CALL std_rv_t
 */
STD_CALL std_rv_t mod_vm_arch_mips_cp0_MINI_create_instance(INOUT std_void_t ** pp_handle)
{
	...
	p_m->p_ops = &mod_vm_arch_mips_cp0_MINI_ops;

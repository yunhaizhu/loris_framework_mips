...
/**
 * @file    mod_vm_arch_mips_cpu_MINI.c
...
STD_CALL std_void_t mod_vm_arch_mips_cpu_initiate(IN mod_vm_arch_mips_cpu_t * p_m);
/**
 * mod_vm_arch_mips_cpu_MINI_init
 * @brief   
 * @param   p_m
 * @param   arg
 * @param   arg_len
 ...
 */
STD_CALL std_rv_t mod_vm_arch_mips_cpu_MINI_init(IN mod_vm_arch_mips_cpu_t * p_m, IN const std_char_t * arg,
						 IN std_int_t arg_len)
{
	...
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_reset, p_imp_m);

	snprintf(key, sizeof(key), "%lul-%s", p_imp_m->unique_id, "mod_vm_arch_mips_cpu_fetch");
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_fetch, p_imp_m);

	snprintf(key, sizeof(key), "%lul-%s", p_imp_m->unique_id, "mod_vm_arch_mips_cpu_exec");
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_exec, p_imp_m);

	snprintf(key, sizeof(key), "%lul-%s", p_imp_m->unique_id, "mod_vm_arch_mips_cpu_set_pc");
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_set_pc, p_imp_m);

	snprintf(key, sizeof(key), "%lul-%s", p_imp_m->unique_id, "mod_vm_arch_mips_cpu_set_llbit");
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_set_llbit, p_imp_m);

	snprintf(key, sizeof(key), "%lul-%s", p_imp_m->unique_id, "mod_vm_arch_mips_cpu_is_in_bdslot");
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_is_in_bdslot, p_imp_m);

	snprintf(key, sizeof(key), "%lul-%s", p_imp_m->unique_id, "mod_vm_arch_mips_cpu_break_idle");
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_break_idle, p_imp_m);

	snprintf(key, sizeof(key), "%lul-%s", p_imp_m->unique_id, "mod_vm_arch_mips_cpu_run");
	mod_shell_register(p_imp_m->p_mod_shell, key, std_safe_strlen(key, sizeof(key)),
			   shell_stub_mod_vm_arch_mips_cpu_MINI_run, p_imp_m);

    mod_vm_arch_mips_cpu_initiate(p_m);
	return STD_RV_SUC;
}

/**
 * mod_vm_arch_mips_cpu_MINI_cleanup
 * @brief   
 * @param   p_m
 * @return  STD_CALL std_rv_t
 */
STD_CALL std_rv_t mod_vm_arch_mips_cpu_MINI_cleanup(mod_vm_arch_mips_cpu_t * p_m)
{
	mod_vm_arch_mips_cpu_imp_t *p_imp_m = (mod_vm_arch_mips_cpu_imp_t *) p_m;
	mod_iid_t mod_shell_iid = MOD_SHELL_IID;
	std_char_t key[BUF_SIZE_128] = "\0";
...
/**
 * mod_vm_arch_mips_cpu_MINI_reset
 * @brief   
 * @param   p_m
 * @param   entry
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cpu_MINI_reset(IN mod_vm_arch_mips_cpu_t * p_m, IN std_uint_t entry)
{
...
/**
 * mod_vm_arch_mips_cpu_MINI_fetch
 * @brief   
 * @param   p_m
 * @param   insn
 * @return  STD_CALL             std_uint_t
 */
STD_CALL std_uint_t mod_vm_arch_mips_cpu_MINI_fetch(IN mod_vm_arch_mips_cpu_t * p_m, IN std_uint_t * insn)
{
    mod_vm_arch_mips_cpu_imp_t *cvm_info = (mod_vm_arch_mips_cpu_imp_t *)p_m;
    cvm_arch_mips_cpu_t *cpu = &(cvm_info->cpu);
    std_int_t ret;
...
/**
 * mod_vm_arch_mips_cpu_MINI_exec
 * @brief   
 * @param   p_m
 * @param   insn
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cpu_MINI_exec(IN mod_vm_arch_mips_cpu_t * p_m, IN std_uint_t insn)
{
    mod_vm_arch_mips_cpu_imp_t *cvm_info = (mod_vm_arch_mips_cpu_imp_t *)p_m;
    cvm_arch_mips_cpu_t *cpu = &(cvm_info->cpu);
    std_32_t res;
...
/**
 * mod_vm_arch_mips_cpu_MINI_set_pc
 * @brief   
 * @param   p_m
 * @param   pc
 * @return  STD_CALL             std_uint_t
 */
STD_CALL std_uint_t mod_vm_arch_mips_cpu_MINI_set_pc(IN mod_vm_arch_mips_cpu_t * p_m, IN std_uint_t pc)
{
    mod_vm_arch_mips_cpu_imp_t *cvm_info = (mod_vm_arch_mips_cpu_imp_t *)p_m;
    cvm_arch_mips_cpu_t *cpu = &(cvm_info->cpu);
...
/**
 * mod_vm_arch_mips_cpu_MINI_set_llbit
 * @brief   
 * @param   p_m
 * @param   llbit
 * @return  STD_CALL             std_uint_t
 */
STD_CALL std_uint_t mod_vm_arch_mips_cpu_MINI_set_llbit(IN mod_vm_arch_mips_cpu_t * p_m, IN std_uint_t llbit)
{
    mod_vm_arch_mips_cpu_imp_t *cvm_info = (mod_vm_arch_mips_cpu_imp_t *)p_m;
    cvm_arch_mips_cpu_t *cpu = &(cvm_info->cpu);
...
/**
 * mod_vm_arch_mips_cpu_MINI_is_in_bdslot
 * @brief   
 * @param   p_m
 * @return  STD_CALL             std_uint_t
 */
STD_CALL std_uint_t mod_vm_arch_mips_cpu_MINI_is_in_bdslot(IN mod_vm_arch_mips_cpu_t * p_m)
{
    mod_vm_arch_mips_cpu_imp_t *cvm_info = (mod_vm_arch_mips_cpu_imp_t *)p_m;
    cvm_arch_mips_cpu_t *cpu = &(cvm_info->cpu);
...
/**
 * mod_vm_arch_mips_cpu_MINI_break_idle
 * @brief   
 * @param   p_m
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cpu_MINI_break_idle(IN mod_vm_arch_mips_cpu_t * p_m)
{
    mod_vm_arch_mips_cpu_imp_t *cvm_info = (mod_vm_arch_mips_cpu_imp_t *)p_m;
    cvm_arch_mips_cpu_t *cpu = &(cvm_info->cpu);
...
/**
 * mod_vm_arch_mips_cpu_MINI_run
 * @brief   
 * @param   p_m
 * @return  STD_CALL             std_void_t
 */
STD_CALL std_void_t mod_vm_arch_mips_cpu_MINI_run(IN mod_vm_arch_mips_cpu_t * p_m)
{
    mod_vm_arch_mips_cpu_imp_t *cvm_info = (mod_vm_arch_mips_cpu_imp_t *)p_m;
    cvm_arch_mips_cpu_t *cpu = &(cvm_info->cpu);
...
RESTART:
    ...
    if (cpu->pc == 0xbfc00380ULL){ //interrupt handle entry
...
struct mod_vm_arch_mips_cpu_ops_st mod_vm_arch_mips_cpu_MINI_ops = {
	mod_vm_arch_mips_cpu_MINI_init,
	mod_vm_arch_mips_cpu_MINI_cleanup,
 ...
 * @return  STD_CALL std_rv_t
 */
STD_CALL std_rv_t mod_vm_arch_mips_cpu_MINI_create_instance(INOUT std_void_t ** pp_handle)
{
	...
	p_m->p_ops = &mod_vm_arch_mips_cpu_MINI_ops;

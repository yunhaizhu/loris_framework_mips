...
def mod_vm_arch_mips_cpu_run(var root, var ret)
{
    var name_value_hash<> = <>
    var json_args
    ...
    ret = run("mod_vm_arch_mips_cpu_run", root, json_args)
}
...
def run_run(var root, var run_state)
{
    var ret_run
    var keys_tuple = run_state.find("keys_tuple")
    var hash_key_value = run_state.find("hash_key_value")

    mod_vm_arch_mips_cpu_run(root,ret_run)
}
...
def main()
{
    ...
    run_run(mod_vm_arch_mips_cpu_test, run_state)

...
def mod_vm_memory_access(var root, var vaddr, var op_code, var op_size, var op_type, var data, var has_set_value, var ret)
{
    var name_value_hash<> = <"vaddr":vaddr,"op_code":op_code,"op_size":op_size,"op_type":op_type,"data":data,"has_set_value":has_set_value>
    var json_args
...
def run_access(var root, var run_state)
{
    ...
    mod_vm_memory_access(root,vaddr,op_code,op_size,op_type,data,has_set_value,ret_access)
}

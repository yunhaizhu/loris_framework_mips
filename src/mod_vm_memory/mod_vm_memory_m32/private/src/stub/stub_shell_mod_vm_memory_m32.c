...
/**
 * @file    stub_shell_mod_vm_memory_m32.c
 ...
 */
STD_CALL std_char_t *shell_stub_mod_vm_memory_m32_initiate(IN std_void_t *p_handle, IN std_char_t *params)
{
    json_t const *json;
 ...
 * @return  STD_CALL std_char_t *
 */
STD_CALL std_char_t *shell_stub_mod_vm_memory_m32_lookup(IN std_void_t *p_handle, IN std_char_t *params)
{
    json_t const *json;
    std_char_t response_string[128];
    std_char_t *response;
 ...
 * @return  STD_CALL std_char_t *
 */
STD_CALL std_char_t *shell_stub_mod_vm_memory_m32_access(IN std_void_t *p_handle, IN std_char_t *params)
{
    json_t const *json;
    std_char_t response_string[128];
    std_char_t *response;
    ...
    /******server_stub_call*****/
    ret =
            mod_vm_memory_access(mod_vm_memory, vaddr, op_code, op_size, op_type, data, has_set_value);
 ...
 * @return  STD_CALL std_char_t *
 */
STD_CALL std_char_t *shell_stub_mod_vm_memory_m32_map(IN std_void_t *p_handle, IN std_char_t *params)
{
    json_t const *json;
    std_char_t response_string[128];
    std_char_t *response;
 ...
 * @return  STD_CALL std_char_t *
 */
STD_CALL std_char_t *shell_stub_mod_vm_memory_m32_unmap(IN std_void_t *p_handle, IN std_char_t *params)
{
    json_t const *json;
    std_char_t response_string[128];
    std_char_t *response;

...
/**
 * @file    mod_vm_device_INT_bundle.c
...
static mod_iid_t mod_vm_device_iid = MOD_VM_DEVICE_INT_IID;
...
{
    STD_ASSERT_RV(mod_register_instance_func(&mod_vm_device_iid, mod_vm_device_INT_create_instance) == STD_RV_SUC,
                  STD_RV_ERR_FAIL);

...
/**
 * @file    stub_shell_mod_vm_device_RAM.c
 ...
 */
STD_CALL std_char_t *shell_stub_mod_vm_device_RAM_initiate(IN std_void_t * p_handle, IN std_char_t * params)
{
	json_t const *json;
 ...
 * @return  STD_CALL std_char_t *
 */
STD_CALL std_char_t *shell_stub_mod_vm_device_RAM_reset(IN std_void_t * p_handle, IN std_char_t * params)
{
	json_t const *json;
	std_char_t response_string[128];
	std_char_t *response;
 ...
 * @return  STD_CALL std_char_t *
 */
STD_CALL std_char_t *shell_stub_mod_vm_device_RAM_access(IN std_void_t * p_handle, IN std_char_t * params)
{
	json_t const *json;
	std_char_t response_string[128];
	std_char_t *response;
 ...
 * @return  STD_CALL std_char_t *
 */
STD_CALL std_char_t *shell_stub_mod_vm_device_RAM_command(IN std_void_t * p_handle, IN std_char_t * params)
{
	json_t const *json;
	std_char_t response_string[128];
	std_char_t *response;
